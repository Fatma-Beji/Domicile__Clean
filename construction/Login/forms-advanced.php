...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <form action="forms-advanced.php " method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Employee Input</strong> <small> Agent</small>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <select data-placeholder="Choose a country..." multiple class="standardSelect" name="country">
    ...
    $image=basename( $_FILES["image"]["name"]);
                    ...
                    $req=" insert into agent ( namea, adra, villea, maila, notea, gendera, agea, imga, tela) values('$name','$adr','$country','$mail','$note','$gender','$age','$image','$tel')";
