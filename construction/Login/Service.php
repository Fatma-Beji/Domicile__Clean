        ...
        <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <strong> Input</strong> <small> Service</small>
                            </div>
                    ...
                    <div class="col-xs-6 col-sm-6">
                        ...
                        <div class="card-body">
                          ...
                          <select data-placeholder="Choose a Feature..." multiple class="standardSelect" name="country">
                            <option value="" label="default"></option>
                            <option value="Cleaning">Cleaning</option>
                            <option value="Ironing">Ironing</option>
                            <option value="Gardening">Gardening</option>
                            <option value="Taking Care Of Children">Taking Care Of Children</option>
                            <option value="Animals Breeding">Animals Breeding</option>
          ...
          <?php 
            ...
            if(isset($_POST['sub'] ))
            {
                    ...
                    $req=" insert into `services`(`noms`, `refs`, `descs`, `nomd`, `ims`) values('$name','$ref','$desc','$country','$photo')";
